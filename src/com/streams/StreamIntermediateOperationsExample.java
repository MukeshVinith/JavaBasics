...
public class StreamIntermediateOperationsExample {
    public static void main(String[] args) {
      ...
      /*  List<List<String>> listOfLists = Arrays.asList(
    	...
    	listOfLists.add("Reflection");
    	listOfLists.add("Collection");
    	listOfLists.add("Stream");
    	listOfLists.add("Structure");
    	listOfLists.add("State");
    	listOfLists.add("Flow");
    	listOfLists.add("Sorting");
    	listOfLists.add("Mapping");
    	listOfLists.add("Reduction");
    	listOfLists.add("Stream");
